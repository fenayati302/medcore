...
| `https://forge.medcore.tech` | Forge — GC AI Receptionist | `forge-contractor-app/dist/` |
...
- `forge.medcore.tech` → Amplify app **forge-contractor**
...
## 3b. Amplify — Forge (`forge-contractor-app`)

Same steps as Sage:

1. Root directory: `forge-contractor-app`
2. Custom domain: `forge.medcore.tech`
...
ALLOWED_ORIGINS=https://medcore.tech,https://www.medcore.tech,https://sage.medcore.tech,https://forge.medcore.tech

# Stripe checkout return URLs, password reset links, appointment emails
AIREALTOR_APP_URL=https://sage.medcore.tech
FORGE_APP_URL=https://forge.medcore.tech
ELEVENLABS_FORGE_AGENT_ID=   # optional; falls back to ELEVENLABS_AIREALTOR_AGENT_ID
```
...
Open http://localhost:8080 (landing), http://localhost:5174 (Sage), http://localhost:5175 (Forge).
